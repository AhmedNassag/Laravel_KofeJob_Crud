                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">{{ trans('main.Departments') }}</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ trans('main.Dashboard') }}</a></li>
                                    <li class="breadcrumb-item active">{{ trans('main.Departments') }}</li>
                                </ul>
                            </div>
                            <div class="col-auto">
                                @can('إضافة الأقسام')
                    ...
                    <div class="row">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example1" class="table table-stripped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @include('dashboard.departments.editModal')
                                                    @include('dashboard.departments.deleteModal')
                                                    @endforeach
                                                    @else
                                                    <tr>
                        ...
                        @include('dashboard.departments.addModal')
                        @include('dashboard.departments.deleteSelectedModal')		
                    </div>	
                </div>
            </div>			
        </div>
